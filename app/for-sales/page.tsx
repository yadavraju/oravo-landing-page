...
export default function ForSalesPage() {
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Does it work with Salesforce?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. Oravo works in Salesforce, HubSpot, Pipedrive, and any CRM with text fields. If you can click in a field, Oravo can type there.",
        },
      },
      {
        "@type": "Question",
        name: "Can I use it on mobile between meetings?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes on macOS and Windows. Mobile apps are coming soon. For now, dictate when you're back at your desk.",
        },
      },
      {
        "@type": "Question",
        name: "How fast can I send follow-ups?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Most sales reps can dictate and send a follow-up email in under 2 minutes—while the conversation is still fresh.",
        },
      },
      {
        "@type": "Question",
        name: "Is it secure for customer data?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. Oravo uses encrypted processing and doesn't store audio. Your customer conversations stay private.",
        },
      },
    ],
  };
