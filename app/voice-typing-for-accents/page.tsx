...
export default function VoiceTypingForAccentsPage() {
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Why does Oravo work better with accents than other apps?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Most voice typing apps are trained on native English speakers. Oravo's AI is specifically trained on diverse speech patterns from over 100 countries, making it understand accented English naturally.",
        },
      },
      {
        "@type": "Question",
        name: "Do I need to change how I speak?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No! Speak naturally with your accent. Oravo adapts to you, not the other way around. The more you use it, the better it understands your unique speech patterns.",
        },
      },
      {
        "@type": "Question",
        name: "My accent is quite strong. Will it still work?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes! Oravo is designed for exactly this scenario. Even with a strong accent, you'll get 98%+ accuracy. Our users with the strongest accents are often the most satisfied.",
        },
      },
      {
        "@type": "Question",
        name: "Does it work with code-switching (mixing languages)?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes! If you naturally mix English with words from your native language, Oravo can handle that too. It recognizes when you switch and transcribes accordingly.",
        },
      },
    ],
  };
