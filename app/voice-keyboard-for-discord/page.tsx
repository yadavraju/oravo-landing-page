...
export const metadata: Metadata = {
  title: "Voice Keyboard for Discord: Chat 4x Faster While Gaming | Oravo AI",
  description:
    "Transform Discord communication with Oravo's voice keyboard. Dictate messages in servers, DMs & voice channels 4x faster than typing. Perfect for gaming and communities.",
  keywords: [
    ...
    "discord voice dictation",
    "speak to text discord",
    "voice messages discord",
    "discord voice input",
    "hands-free discord messaging",
    "gaming voice to text",
    "discord chat while gaming",
    "discord typing alternative",
    "voice chat to text discord",
    "discord accessibility",
  ],
  openGraph: {
    title: "Voice Keyboard for Discord: Chat 4x Faster While Gaming | Oravo AI",
    description:
      "Transform Discord communication with Oravo's voice keyboard. Dictate messages 4x faster than typing while gaming.",
  ...
  twitter: {
    ...
    description:
      "Dictate Discord messages 4x faster with Oravo's AI voice keyboard. Perfect for gaming and communities.",
    images: ["/og-image.png"],
  },
  alternates: {
            ...
            <section className="px-6 md:px-12 py-12 md:py-20 border-b border-[rgba(55,50,47,0.12)]">
              <div className="max-w-[800px] mx-auto text-center">
                ...
                <p className="text-[#605A57] text-lg md:text-xl leading-relaxed font-sans mb-8 max-w-[640px] mx-auto">
                  Chat in Discord servers and DMs 4x faster without taking your hands off the keyboard or controller. Oravo AI converts your voice to perfectly formatted text while you game, stream, or multitask.
                </p>
              ...
              <div className="max-w-[900px] mx-auto">
                <div className="text-center mb-12">
                  ...
                  <p className="text-[#605A57] text-base md:text-lg font-sans max-w-[600px] mx-auto">
                    Stay in the game while staying connected
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <FeatureCard
                    icon={
                      <svg className="w-6 h-6 text-[#5865F2]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                      </svg>
                    }
                    title="Chat While Gaming"
                    description="Keep your hands on your controller or keyboard. Speak to type in Discord without pausing your game or losing focus."
                  />
                  ...
                  <FeatureCard
                    ...
                    title="Server Messages at Speaking Speed"
                    description="Respond to server conversations instantly. Join discussions, share updates, and engage with your community 4x faster."
                  />
                  ...
                  <FeatureCard
                    ...
                    description="Handle private messages without breaking flow. Perfect for coordinating with teammates or chatting with friends."
                  />
                  ...
                  <FeatureCard
                    ...
                    description="Chat with your audience while streaming. Respond to viewers without interrupting your content."
                  />
                  ...
                  <FeatureCard
                    ...
                    description='Say "laughing emoji" or "fire emoji" and Oravo transcribes Discord-compatible emoji codes automatically.'
                  />
                  ...
                  <FeatureCard
                    ...
                    description="Works with Discord desktop app and web browser. Same seamless experience everywhere."
                  />
                </div>
              </div>
            </section>
                ...
                <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 md:p-10 border border-[rgba(55,50,47,0.12)]">
                  <div className="space-y-8">
                    ...
                    <StepCard
                      number={2}
                      title="Open Discord"
                      description="Launch Discord desktop app or open Discord in your browser. Oravo works identically in both environments."
                    />
                    <StepCard
                      number={3}
                      title="Click Any Chat"
                      description="Position your cursor in any server channel, DM, or group chat message box."
                    />
                    <StepCard
                      number={4}
                      title="Press Hotkey & Speak"
                      description="Activate with your customizable hotkey and speak naturally. Perfect for mid-game communication."
                    />
                    <StepCard
                      number={5}
                      title="Send Your Message"
                      description="Your speech appears as formatted text instantly. Hit Enter and get back to gaming."
                    />
                  </div>
                </div>
              </div>
            ...
            <section className="px-6 md:px-12 py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)]">
              <div className="max-w-[900px] mx-auto">
                <div className="text-center mb-12">
                  ...
                  />
                  <h2 className="text-[#37322F] text-3xl md:text-4xl font-normal font-serif mt-4 mb-4">
                    Perfect for Every Discord User
                  </h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <UseCaseCard
                    ...
                    scenario="Mid-match team coordination"
                    withOravo="Call out positions, coordinate strategies, and communicate with teammates without taking hands off your controls."
                    timeSaved="100%"
                  />

                  <UseCaseCard
                    title="Community Management"
                    scenario="Managing active Discord servers"
                    withOravo="Respond to members, moderate discussions, and engage with your community at speaking speed."
                    result="Handle 3x more conversations"
                  />

                  <UseCaseCard
                    title="Content Streaming"
                    scenario="Engaging with chat while streaming"
                    withOravo="Respond to viewer messages without interrupting your content. Keep the conversation flowing naturally."
                    result="Higher viewer engagement"
                  />

                  <UseCaseCard
                    title="Study Groups & Collaboration"
                    scenario="Group projects and study sessions"
                    withOravo="Share detailed explanations, discuss concepts, and collaborate on assignments at speaking speed."
                    timeSaved="75%"
                  />
                </div>
              </div>
            ...
            <section className="px-6 md:px-12 py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)]">
              <div className="max-w-[800px] mx-auto">
                ...
                <div className="space-y-4">
                  <FAQItem
                    question="Does it work while I'm in a game?"
                    answer="Yes! Oravo runs in the background and captures your voice even while games are in fullscreen. Just press your hotkey, speak, and continue gaming."
                  />

                  <FAQItem
                    question="Will my game audio interfere with dictation?"
                    answer="Oravo uses advanced noise cancellation to filter out game audio, music, and background noise. Your voice comes through clearly even in loud environments."
                  />

                  <FAQItem
                    question="Can I use it in voice channels?"
                    answer="Oravo converts speech to text for typing in text channels. It's different from Discord's voice chat—you speak, and Oravo types your message."
                  />

                  <FAQItem
                    question="Does it work with Discord Nitro features?"
                    answer="Absolutely. Oravo works with all Discord features including Nitro. It simply types text into Discord—all your emojis, stickers, and formatting work normally."
                  />

                  <FAQItem
                    question="What about gaming slang and terms?"
                    answer="Oravo recognizes gaming terminology, popular game names, and Discord-specific language. It learns your vocabulary over time for even better accuracy."
                  />

                  <FAQItem
                    question="Can I customize the activation hotkey?"
                    answer="Yes! Set any hotkey that works with your gaming setup. Choose something that doesn't conflict with your game controls."
                  />
                </div>
              </div>
            </section>
              ...
              <div className="max-w-[700px] mx-auto text-center">
                <div className="bg-gradient-to-br from-[#5865F2] to-[#4752C4] rounded-3xl p-8 md:p-12 shadow-[0_8px_48px_rgba(88,101,242,0.3)]">
                  <h2 className="text-white text-2xl md:text-4xl font-normal font-serif mb-4">
                    Chat Faster, Game Better
                  </h2>
                  <p className="text-white/90 text-base md:text-lg leading-relaxed font-sans mb-8">
                    Stop typing and start speaking. Keep your hands on your game and let Oravo handle Discord messages at 4x your typing speed.
                  </p>
