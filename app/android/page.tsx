    ...
    <div className="w-full min-h-screen relative bg-[#F7F5F3] overflow-x-hidden flex flex-col justify-start items-center">
      <div className="relative flex flex-col justify-start items-center w-full">
        <div className="w-full max-w-none px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] relative flex flex-col justify-start items-start min-h-screen">
                  ...
                  <div className="flex flex-col gap-6 md:gap-8 order-1">
                    ...
                    <div className="flex flex-row gap-3 flex-wrap">
                      <a
                        ...
                        onClick={() => trackPlayStoreOutbound("android-page")}
                        target="_blank"
                      ...
                      <a
                        ...
                        className="opacity-50 cursor-not-allowed hover:opacity-60 transition-opacity"
                      >
                        <img
                          src="/applestore.png"
          ...
          {/* Features Section */}
          <section className="w-full py-16 md:py-24 border-b border-[rgba(55,50,47,0.12)]">
            <div className="max-w-[900px] mx-auto px-4 sm:px-6 md:px-8">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <FeatureItem
                  title="Use it anywhere you write"
                  description="Oravo works wherever you're already typing — any app, any text field."
                />
                <FeatureItem
                  title="100+ languages"
                  description="Speak naturally in the language you prefer. Oravo translates to English instantly."
                />
                <FeatureItem
                  title="Keep talking as you move between apps"
                  description="Oravo keeps up, even as you switch apps mid-thought."
                />
                <FeatureItem
                  title="Oravo edits as you speak"
                  description="Clean, formatted text without extra effort. No filler words, no mistakes."
                />
              </div>
            </div>
          </section>
