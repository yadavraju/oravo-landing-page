...
export function LatestBlogSection() {
  ...
  useEffect(() => {
    async function fetchPosts() {
      try {
        const fetchedPosts = await client.fetch(latestPostsQuery)
  ...
  return (
    <section className="w-full py-20 px-4 sm:px-6 lg:px-12 bg-white border-t border-[rgba(55,50,47,0.12)]">
              ...
              >
                ...
                <div className="flex flex-col gap-3 p-6 pt-0">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    {hasAuthorImage && (
                      <div className="relative w-8 h-8 rounded-full overflow-hidden bg-[#F7F5F3]">
                        <Image
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[#847971] text-xs font-normal font-sans">
